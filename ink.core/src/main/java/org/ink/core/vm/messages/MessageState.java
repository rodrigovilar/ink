...
import static org.ink.core.vm.factory.internal.CoreNotations.Ids.INVALID_MODELPATH;
...
@CoreInstanceSpec(
	ids = { 
		MISSING_FIELD_DATA, WRONG_VALUE_TYPE, 
	...
	locations = { 
		...
		@CoreInstanceValuesLocation(indexes = { MessageState.p_text }) }, 
	values = { 
		@CoreInstanceValues(values = { "The field ''{0}'' should not be empty." }), 
