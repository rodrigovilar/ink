 ...
 */
@ValidatorMessages(codes={"min.value.violation", "values.comparison.violation", "max.value.violation"}, 
		   messages={"ink.core:min_value_violation", "ink.core:values_comparison_violation", "ink.core:max_value_violation"})
