package org.ink.core.vm.test.proxy;
...
public class ProxyPerformanceComparison {
	...
	public static void main(String[] args) throws Exception {
		Callable<Integer> jdkProxy = (Callable<Integer>) Proxy.newProxyInstance(ClassLoader.getSystemClassLoader(), new Class[] { Callable.class }, new JdkHandler(new Counter()));
