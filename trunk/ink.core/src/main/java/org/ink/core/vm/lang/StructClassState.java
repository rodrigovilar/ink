 ...
 */
@CoreClassSpec(constraintsClass = ClassConstraintsState.class, mirrorClass = StructClassMirrorState.class, javaMapping = JavaMapping.Only_State, finalValues = { "Only_State" }, finalValuesLocation = { InkClassState.p_java_mapping })
