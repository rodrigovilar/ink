 ...
 */
@CoreClassSpec(constraintsClass = ClassConstraintsState.class, mirrorClass = ClassMirrorState.class, javaMapping = JavaMapping.ONLY_STATE, finalValuesLocation = { InkClassState.p_component_type }, finalValues = { "Root" })
