 ...
 */
@CoreClassSpec(constraintsClass=ClassConstraintsState.class,mirrorClass=ClassMirrorState.class,
		finalValuesLocation=InkClassState.p_can_cache_behavior_instance,finalValues="false",
		javaMapping=JavaMapping.Only_State)
