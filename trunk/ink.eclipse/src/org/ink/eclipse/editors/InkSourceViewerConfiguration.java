...
public class InkSourceViewerConfiguration extends TextSourceViewerConfiguration {
	...
	protected InkScanner getInkScanner() {
		if (scanner == null) {
			...
			scanner.setDefaultReturnToken(new Token(new TextAttribute(colorManager.getColor(InkColorConstants.DEFAULT))));
		}
		return scanner;
	}
	...
	protected InkTagScanner getXMLTagScanner() {
		if (tagScanner == null) {
			...
			tagScanner.setDefaultReturnToken(new Token(new TextAttribute(colorManager.getColor(InkColorConstants.TAG))));
		}
		return tagScanner;
	}
	...
	public IPresentationReconciler getPresentationReconciler(ISourceViewer sourceViewer) {
		...
		TextAttribute textAttribute = new TextAttribute(colorManager.getColor(InkColorConstants.COMMENT));
	...
	public String[] getConfiguredContentTypes(ISourceViewer sourceViewer) {
		return new String[] { IDocument.DEFAULT_CONTENT_TYPE, InkPartitionScanner.INK_COMMENT, InkPartitionScanner.INK_STRING, };
	}
